...
public class GoodsRepository : IGoodsRepository
{
    ...
    public GoodsRepository(IConfiguration configuration)
    {
        ...
        string connectionString =
            ...
            ?? throw new InvalidOperationException("ConnectionString configuration value is missing.");
    ...
    {
        string sql = @"
            Insert Into Goods (GoodsName, GoodsDescription)
            Values (@GoodsName, @GoodsDescription);
    ...
    public GoodsBase GetGoodsById(int goodsId)
    {
        ...
        return db.Query<GoodsBase>(q, new { GoodsId = goodsId }).SingleOrDefault()
            ?? throw new InvalidOperationException($"Goods record not found. GoodsId: {goodsId}");
    }

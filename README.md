# DotNetNote 9.0 - 닷넷노트 9.0

ASP.NET Core 9.0 개발, 강의, 집필 소스 모음
...
1.0 버전부터 현재 9.0 버전까지 업데이트가 되고 있습니다.

특별한 경우가 아니면 버전 업데이트에 맞는 수정만할 뿐이지, 새롭게 추가되는 기능은 없습니다.


## ASP.NET Core 9.0 전체 강의 소스

박용준 강사가 진행하는 ASP.NET Core 9.0 강의의 전체 소스는 현재 리포지토리에 들어 있습니다. 

ASP.NET Core 9.0 이전 버전에서 업그레이드한 소스이므로 Program.cs 파일과 Startup.cs 파일을 함께 사용합니다. 
